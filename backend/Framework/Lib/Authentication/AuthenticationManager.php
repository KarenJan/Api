...
class AuthenticationManager{
	...
	public function __construct(){
		$this->flashMessenger = Api::app()->getObjectManager()->get('flashMessenger');
		$this->cookieObject = Api::app()->getObjectManager()->get('cookie');
		$this->memcacheObject = Api::app()->getObjectManager()->get('memcache');
		$this->fileSystemObject = Api::app()->getObjectManager()->get('fileSystem');
	}
	...
	public function logout(){
		...
		$memcache = Api::app()->getObjectManager()->get('memcache');
	...
	public function register($data){
		$cookie = \Framework\Api::app()->getObjectManager()->get('cookie');
		$language = ($cookie->get('m_language')) ? $cookie->get('m_language') : \Framework\Api::app()->language ;
