...
use \Framework\Core\Database\PDO\Exceptions\PDOException;
use \Framework\Core\Database\PDO\Exceptions\ConnectionParamsNotExistsException;
use \Framework\Core\Database\PDO\Exceptions\NoConnectionException;
use \Framework\Core\Database\PDO\Exceptions\QueryFailedException;
...
class Driver{
	...
	*/
	...
	{
	    //  \Framework\Api::app()->_dump($query);
	    // 	\Framework\Api::app()->_dump($params);
		if (is_null($this->dbh))
